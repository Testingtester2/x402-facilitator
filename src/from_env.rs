...
pub const ENV_RPC_SHIBARIUM: &str = "RPC_URL_SHIBARIUM";
pub const ENV_RPC_SHIBARIUM_PUPPYNET: &str = "RPC_URL_SHIBARIUM_PUPPYNET";
...
pub fn rpc_env_name_from_network(network: Network) -> &'static str {
    match network {
        ...
        Network::Shibarium => ENV_RPC_SHIBARIUM,
        Network::ShibariumPuppynet => ENV_RPC_SHIBARIUM_PUPPYNET,
    }
}
